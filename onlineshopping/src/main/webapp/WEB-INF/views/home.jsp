			...
			<div class="row carousel-holder">
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        ...
                        <hr/>
                        <a class="btn btn-primary" href="${images}/PRDABC123DEFX.jpg">More Products</a>
                    </div>
               ...
               <div class="row is-table-row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Checkout more products!</h4>
                        <hr/>
                        <a class="btn btn-primary" href="${images}/banner3.jpg">More Products</a>
                    </div>
